      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div className="text-center lg:text-left">
          ...
          <p className="text-[15px] text-gray-600 leading-relaxed max-w-2xl mx-auto lg:mx-0 mb-10 sm:mb-14">
            Explore how Tonius Frank - The Mortgage Disrupters can simplify your
            home financing journey. Visit your website to discover expert
            mortgage services and personalized refinancing options tailored to
            your needs. Learn more today about achieving your dream home with
