        ...
        <div className="flex flex-col lg:flex-row justify-between gap-10 items-start">
          <div className="w-full lg:w-[600px]">
            ...
            <p className="text-gray-600 text-center lg:text-left mt-4 text-sm max-w-2xl">
              Experience a seamless home financing journey with Tonius Frank -
              The Mortgage Disrupters. Our professional mortgage services are
              just a click away on our website. Whether you're buying your first
              home or looking to refinance, we provide solutions tailored to
              your needs. Visit our website today to explore how we can help you
              achieve your dream home! Explore our comprehensive range of loan
              products designed to meet your unique financial needs and
              homeownership goals.
            </p>
