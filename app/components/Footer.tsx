    ...
    <div className="bg-[#1c1c1c] text-white rounded-t-3xl px-6 py-10 md:px-10 w-full mx-auto mt-10">
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-10">
        ...
        <div>
          ...
          <p className="mb-4 flex flex-row justify-center items-start gap-2">
            <Image
            ...
            />
            <a
              href="https://www.google.com/maps/search/?api=1&query=1526+Monte+Sano+Ave+Office+%234+Augusta+GA+30904"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-gray-300 transition-colors"
            >
              2909 E. Arkansas Ln., Arlington, 
              <br />
              TX, United States, 76010
            </a>
            ...
            {[
              {
                ...
                alt: "Facebook",
                href: "https://www.facebook.com/toniusfrankteam/#",
              },
              // {
